...
const be_const_member_t lv_gpio_constants[] = {
    ...
    { "ADC_CURRENT", (int32_t) GPIO_ADC_CURRENT },
    ...
    { "ADC_VOLTAGE", (int32_t) GPIO_ADC_VOLTAGE },
    ...
    { "ASR650X_RX", (int32_t) GPIO_ASR650X_RX },
    { "ASR650X_TX", (int32_t) GPIO_ASR650X_TX },
    ...
    { "BL0906_RX", (int32_t) GPIO_BL0906_RX },
    ...
    { "BP1658CJ_CLK", (int32_t) GPIO_BP1658CJ_CLK },
    { "BP1658CJ_DAT", (int32_t) GPIO_BP1658CJ_DAT },
    ...
    { "DAC", (int32_t) -1 },
    { "DALI_RX", (int32_t) GPIO_DALI_RX },
    { "DALI_RX_INV", (int32_t) GPIO_DALI_RX_INV },
    { "DALI_TX", (int32_t) GPIO_DALI_TX },
    { "DALI_TX_INV", (int32_t) GPIO_DALI_TX_INV },
    ...
    { "DI", (int32_t) GPIO_DI },
    { "DINGTIAN_CLK", (int32_t) GPIO_DINGTIAN_CLK },
    { "DINGTIAN_OE", (int32_t) GPIO_DINGTIAN_OE },
    { "DINGTIAN_PL", (int32_t) GPIO_DINGTIAN_PL },
    { "DINGTIAN_Q7", (int32_t) GPIO_DINGTIAN_Q7 },
    { "DINGTIAN_RCK", (int32_t) GPIO_DINGTIAN_RCK },
    { "DINGTIAN_SDI", (int32_t) GPIO_DINGTIAN_SDI },
    { "DISPLAY_RESET", (int32_t) GPIO_DISPLAY_RESET },
    ...
    { "GM861_RX", (int32_t) GPIO_GM861_RX },
    { "GM861_TX", (int32_t) GPIO_GM861_TX },
    ...
    { "HSDIO_CLK", (int32_t) GPIO_HSDIO_CLK },
    { "HSDIO_CMD", (int32_t) GPIO_HSDIO_CMD },
    { "HSDIO_D0", (int32_t) GPIO_HSDIO_D0 },
    { "HSDIO_D1", (int32_t) GPIO_HSDIO_D1 },
    { "HSDIO_D2", (int32_t) GPIO_HSDIO_D2 },
    { "HSDIO_D3", (int32_t) GPIO_HSDIO_D3 },
    { "HSDIO_RST", (int32_t) GPIO_HSDIO_RST },
    { "HX711_DAT", (int32_t) GPIO_HX711_DAT },
    { "HX711_SCK", (int32_t) GPIO_HX711_SCK },
    { "I2C_SCL", (int32_t) GPIO_I2C_SCL },
    { "I2C_SDA", (int32_t) GPIO_I2C_SDA },
    { "I2C_SER_RX", (int32_t) GPIO_I2C_SER_RX },
    { "I2C_SER_TX", (int32_t) GPIO_I2C_SER_TX },
    ...
    { "LD2402_RX", (int32_t) GPIO_LD2402_RX },
    { "LD2402_TX", (int32_t) GPIO_LD2402_TX },
    { "LD2410S_RX", (int32_t) GPIO_LD2410S_RX },
    { "LD2410S_TX", (int32_t) GPIO_LD2410S_TX },
    { "LD2410_RX", (int32_t) GPIO_LD2410_RX },
    { "LD2410_TX", (int32_t) GPIO_LD2410_TX },
    ...
    { "MBR_TX_ENA", (int32_t) GPIO_MBR_TX_ENA },
    { "MBS_RX_ENA", (int32_t) GPIO_MBS_RX_ENA },
    { "MCP23SXX_CS", (int32_t) GPIO_MCP23SXX_CS },
    { "MCP23XXX_INT", (int32_t) GPIO_MCP23XXX_INT },
    ...
    { "MKSKYBLU_RX", (int32_t) GPIO_MKSKYBLU_RX },
    ...
    { "NRG_MBS_TX_ENA", (int32_t) GPIO_NRG_MBS_TX_ENA },
    { "NRG_SEL", (int32_t) GPIO_NRG_SEL },
    { "NRG_SEL_INV", (int32_t) GPIO_NRG_SEL_INV },
    { "OLED_RESET", (int32_t) GPIO_DISPLAY_RESET },
    ...
    { "PCF8574_INT", (int32_t) GPIO_PCF8574_INT },
    ...
    { "TM1640DIN", (int32_t) GPIO_TM1640DIN },
    ...
    { "TWAI_BO", (int32_t) GPIO_TWAI_BO },
    { "TWAI_CLK", (int32_t) GPIO_TWAI_CLK },
    { "TWAI_RX", (int32_t) GPIO_TWAI_RX },
    { "TWAI_TX", (int32_t) GPIO_TWAI_TX },
    ...
    { "VID6608_CW", (int32_t) GPIO_VID6608_CW },
    { "VID6608_F", (int32_t) GPIO_VID6608_F },
