...
const char HTTP_SNS_NOX[]           PROGMEM = "{s}%s "  D_NOX                 "{m}%d"                             "{e}";
const char HTTP_SNS_VOC[]           PROGMEM = "{s}%s "  D_VOC                 "{m}%d"                             "{e}";
...
const char HTTP_SNS_F_PARTICLE_NUMBER_CONCENTRATION[] PROGMEM = "{s}%s " D_PARTICLES                 " %s - %s " D_UNIT_MICROMETER "{m}%1_f " D_UNIT_PER_CUBIC_CENTIMETER "{e}";
